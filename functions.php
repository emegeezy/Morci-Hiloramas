 ...
 * @package Sabino
 */
define( 'SABINO_THEME_VERSION' , '1.1.17' );
...
function sabino_scripts() {
	...
	wp_enqueue_style( 'sabino-font-awesome', get_template_directory_uri().'/includes/font-awesome/css/all.min.css', array(), '5.9.0' );
...
function sabino_add_license_notice() {
	...
	if ( !get_user_meta( $sabino_user_id, 'sabino_flash_notice_ignore' ) ) : ?>
		<div class="notice notice-info sabino-admin-notice sabino-notice-add">
			<h4>
				<?php esc_html_e( 'Thank you for trying out Sabino!', 'sabino' ); ?> -
				<span>
					<?php
					/* translators: %s: 'Recommended Resources' */
					printf( esc_html__( 'Premium is currently on a %1$s for only $18', 'sabino' ), wp_kses( __( '<a href="https://kairaweb.com/go/purchase-sabino/" target="_blank">flash sale</a>', 'sabino' ), array( 'a' => array( 'href' => array(), 'target' => array() ) ) ) );
					?>
				</span>
			</h4>
			<p><?php esc_html_e( 'We\'re here to help... Please read through our help notes below on getting started with Sabino:', 'sabino' ); ?></p>
			<div class="sabino-admin-notice-blocks">
				<div class="sabino-admin-notice-block">
					...
					<p>
						<?php
						/* translators: %s: 'Recommended Resources' */
						printf( esc_html__( 'Read through our %1$s and %2$s and we\'ll help you build a professional website easily.', 'sabino' ), wp_kses( __( '<a href="https://kairaweb.com/go/sabino-recommended-resources/" target="_blank">Recommended Resources</a>', 'sabino' ), array( 'a' => array( 'href' => array(), 'target' => array() ) ) ), wp_kses( __( '<a href="https://kairaweb.com/documentation/" target="_blank">Kaira Documentation</a>', 'sabino' ), array( 'a' => array( 'href' => array(), 'target' => array() ) ) ) );
						?>
					</p>
				...
				<div class="sabino-admin-notice-block">
					...
					<a href="<?php echo esc_url( 'https://kairaweb.com/go/sabino-recommended-resources/' ) ?>" class="sabino-admin-notice-btn-in" target="_blank">
				...
				<div class="sabino-admin-notice-block sabino-nomargin">
					...
					<ul>
						...
						<li>
							<a href="https://kairaweb.com/go/what-sabino-premium-offers/" target="_blank"><?php esc_html_e( 'What does Sabino Premium offer', 'sabino' ); ?></a>
						</li>
					</ul>
